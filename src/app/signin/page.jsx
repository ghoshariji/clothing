        ...
        <div className="mt-7 bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-white-900 dark:border-neutral-700">
          <div className="p-6 sm:p-7">
            <div className="text-center">
              <h1 className="block text-2xl font-bold text-black-800 dark:text-black">
                Sign in
              </h1>
            ...
            <div className="mt-5">
              <button
                type="button"
                className="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-white-50 focus:outline-none focus:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-white-900 dark:border-neutral-700 dark:text-white dark:hover:bg-white-800 dark:focus:bg-white-800"
              >
                <svg
